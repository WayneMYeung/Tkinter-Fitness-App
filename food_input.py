...
class Food_input(tk.Tk):
    def __init__(self):
        ...
        bg_image = Image.open(
            "img1.png")  # Replace "path_to_your_image.jpg" with the actual path to your image
        bg_image = bg_image.resize((560, 320))  # Resize the image to fit the window
    ...
    def create_widgets(self):
        ...
        background_label = tk.Label(background_frame, image=self.background_image)
    ...
    def create_page1(self):
        ...
        goal_label = ttk.Label(self.frames[1], text="What is your breakfast intake?", style="Subtitle.TLabel", font=("Arial", 18, "bold"))
        goal_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

        style = ttk.Style()
        style.configure("Subtitle.TLabel", foreground="#239D60")
        ...
        protein_combo = ttk.Combobox(self.frames[1], values=self.foods["protein_list"],
                                     textvariable=self.breakfast_protein_food_var, state="readonly")
        ...
        protein_amout_entry.config(validate="key",
                                   validatecommand=(
                                   self.register(lambda P: self.validate_input(P, "food amount")), "%P"))
        ...
        vegetable_combo = ttk.Combobox(self.frames[1], textvariable=self.breakfast_vegetable_var,
                                       values=self.foods["veggtable_list"], state="readonly")
        ...
        main_combo = ttk.Combobox(self.frames[1], textvariable=self.breakfast_main_var, values=self.foods["main_list"],
                                  state="readonly")
    ...
    def create_page2(self):
        ...
        goal_label = ttk.Label(self.frames[2], text="What is your Lunch intake?", style="Subtitle.TLabel", font=("Arial", 18, "bold"))
        goal_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")
        ...
        protein_combo = ttk.Combobox(self.frames[2], values=self.foods["protein_list"],
                                     textvariable=self.lunch_protein_food_var, state="readonly")
        protein_combo.grid(row=1, column=1, padx=5, pady=5, sticky="w")
        ...
        vegetable_combo = ttk.Combobox(self.frames[2], textvariable=self.lunch_vegetable_var,
                                       values=self.foods["veggtable_list"], state="readonly")
        vegetable_combo.grid(row=3, column=1, padx=5, pady=5, sticky="w")
        ...
        main_combo = ttk.Combobox(self.frames[2], textvariable=self.lunch_main_var, values=self.foods["main_list"],
                                  state="readonly")
        main_combo.grid(row=5, column=1, padx=5, pady=5, sticky="w")
    ...
    def create_page3(self):
        ...
        goal_label = ttk.Label(self.frames[3], text="What is your Dinner intake?", style="Subtitle.TLabel",  font=("Arial", 18, "bold"))
        goal_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")
        ...
        protein_combo = ttk.Combobox(self.frames[3], values=self.foods["protein_list"],
                                     textvariable=self.dinner_protein_food_var, state="readonly")
        protein_combo.grid(row=1, column=1, padx=5, pady=5, sticky="w")
        ...
        vegetable_combo = ttk.Combobox(self.frames[3], textvariable=self.dinner_vegetable_var,
                                       values=self.foods["veggtable_list"], state="readonly")
        vegetable_combo.grid(row=3, column=1, padx=5, pady=5, sticky="w")
        ...
        main_combo = ttk.Combobox(self.frames[3], textvariable=self.dinner_main_var, values=self.foods["main_list"],
                                  state="readonly")
        main_combo.grid(row=5, column=1, padx=5, pady=5, sticky="w")
